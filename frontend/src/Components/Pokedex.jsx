...
import Lapras from '../../public/Lapras'
          ...
          {imageUrls.length > 0 && (
            <div className="w-full flex justify-center items-center gap-[1vw] px-20 mt-20">
              ...
              <div className="flex items-center gap-2">
                ...
                <NavLink to={`/pokeinfo/${imageUrls[0].number}`} className="relative w-[8vw] h-[8vw] border-2 border-teal-200 bg-black shadow-md shadow-emerald-300 rounded-full">
                  <img className="brightness-50" src="/images/pokeball.png" alt="notfound" />
                  <img className="w-full h-full absolute top-0 left-0" src={imageUrls[0].image} alt="notfound" />
                </NavLink>

                <div className="flex flex-col gap-5">
                  <NavLink to={`/pokeinfo/${imageUrls[1].number}`} className="relative w-[8vw] h-[8vw] border-2 border-teal-200 bg-black shadow-md shadow-emerald-300 rounded-full">
                    <img className="brightness-50" src="/images/pokeball.png" alt="notfound" />
                    <img className="w-full h-full absolute top-0 left-0" src={imageUrls[1].image} alt="notfound" />
                  </NavLink>

                  <NavLink to={`/pokeinfo/${imageUrls[2].number}`} className="relative w-[8vw] h-[8vw] border-2 border-teal-200 bg-black shadow-md shadow-emerald-300 rounded-full">
                    <img className="brightness-50" src="/images/pokeball.png" alt="notfound" />
                ...
                <NavLink to={`/pokeinfo/${imageUrls[3].number}`} className="relative w-[8vw] h-[8vw] border-2 border-teal-200 bg-black shadow-md shadow-emerald-300 rounded-full">
                  <img className="brightness-50" src="/images/pokeball.png" alt="notfound" />
                ...
                <div className="flex flex-col gap-5">
                  <NavLink to={`/pokeinfo/${imageUrls[4].number}`} className="relative w-[8vw] h-[8vw] border-2 border-teal-200 bg-black shadow-md shadow-emerald-300 rounded-full">
                    <img className="brightness-50" src="/images/pokeball.png" alt="notfound" />
                    <img className="w-full h-full absolute top-0 left-0" src={imageUrls[4].image} alt="notfound" />
                  </NavLink>

                  <NavLink to={`/pokeinfo/${imageUrls[5].number}`} className="relative w-[8vw] h-[8vw] border-2 border-teal-200 bg-black shadow-md shadow-emerald-300 rounded-full">
                    <img className="brightness-50" src="/images/pokeball.png" alt="notfound" />
              ...
              <NavLink to={`/pokeinfo/${imageUrls[6].number}`} className="flex items-center justify-center">
                <div className="relative w-[16vw] h-[16vw] border-2 border-teal-200 bg-black shadow-md shadow-emerald-300 rounded-full">
                  <img className="brightness-50" src="/images/pokeball.png" alt="notfound" />
              ...
              <div className="flex items-center gap-2">
                <div className="flex flex-col gap-5">
                  <NavLink to={`/pokeinfo/${imageUrls[7].number}`} className="relative w-[8vw] h-[8vw] border-2 border-teal-200 bg-black shadow-md shadow-emerald-300 rounded-full">
                    <img className="brightness-50" src="/images/pokeball.png" alt="notfound" />
                    <img className="w-full h-full absolute top-0 left-0" src={imageUrls[7].image} alt="notfound" />
                  </NavLink>

                  <NavLink to={`/pokeinfo/${imageUrls[8].number}`} className="relative w-[8vw] h-[8vw] border-2 border-teal-200 bg-black shadow-md shadow-emerald-300 rounded-full">
                    <img className="brightness-50" src="/images/pokeball.png" alt="notfound" />
                ...
                <NavLink to={`/pokeinfo/${imageUrls[9].number}`}>
                  <div className="relative w-[8vw] h-[8vw] border-2 border-teal-200 bg-black shadow-md shadow-emerald-300 rounded-full">
                    <img className="brightness-50" src="/images/pokeball.png" alt="notfound" />
                ...
                <div className="flex flex-col gap-5">
                  <NavLink to={`/pokeinfo/${imageUrls[10].number}`} className="relative w-[8vw] h-[8vw] border-2 border-teal-200 bg-black shadow-md shadow-emerald-300 rounded-full">
                    <img className="brightness-50" src="/images/pokeball.png" alt="notfound" />
                    <img className="w-full h-full absolute top-0 left-0" src={imageUrls[10].image} alt="notfound" />
                  </NavLink>

                  <NavLink to={`/pokeinfo/${imageUrls[11].number}`} className="relative w-[8vw] h-[8vw] border-2 border-teal-200 bg-black shadow-md shadow-emerald-300 rounded-full">
                    <img className="brightness-50" src="/images/pokeball.png" alt="notfound" />
                ...
                {pokemon
                  ...
                  .map((poke, index) => {
                    return (
                      ...
                      <NavLink to={`/pokeinfo/${poke.number}`} key={index} className={`cursor-pointer w-[22vw] h-[35vw] bg-[#0A141E] border-2 border-zinc-100 rounded-xl overflow-hidden`} >
